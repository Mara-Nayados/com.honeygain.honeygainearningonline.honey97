...
public class honeygaincase97_SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.honeygaincase97_splash);
    ...
    private void NextScreen() {
        ...
        hndler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                honeygaincase97_SplashActivity.this.startActivity(new Intent(honeygaincase97_SplashActivity.this, honeygaincase97_start_page.class));
